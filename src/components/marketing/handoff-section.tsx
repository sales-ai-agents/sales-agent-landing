      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="grid grid-cols-1 items-start lg:grid-cols-2">
          <ScrollReveal direction="left" distance={30} delay={0.1}>
            <div className="pb-6">
              <p className="text-foreground mb-10 max-w-2xl text-center text-base md:text-lg lg:text-left">
                Якщо клієнт просить людину або питання виходить за сценарій, агент не імпровізує.
                Він передає дзвінок менеджеру разом із контекстом розмови.
              </p>
          ...
          <div className="flex flex-col gap-0">
            <ScrollReveal direction="right" delay={0.2} distance={35}>
